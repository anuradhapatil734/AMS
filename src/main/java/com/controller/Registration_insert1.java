...
@WebServlet("/Registration_insert1")
public class Registration_insert1 extends HttpServlet {
...
doGet(request,response);
        try {
           ...
           // int rf = (remainStr == null || remainStr.trim().isEmpty()) ? 0 : Integer.parseInt(remainStr);
            ...
            r2.setCourse(course);
            r2.setFee(fee);
            //r2.setRemainingfees(rf);
            r2.setReg_date(regDate);
           ...
           // r2.setPaid(paid);
            ...
            if(b==true) {
                ...
                out.println("location='AddStudent.jsp';"); // redirect to another page after alert
                out.println("</script>");
            }
        } catch (Exception e) {
            e.printStackTrace();
