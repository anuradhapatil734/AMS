    ...
    <div class="row">
        ...
        <div class="col-md-2 sidebar d-flex flex-column p-3" id="sidebar">
            <div class="row bg-white mb-3 rounded">
                <div class="col-sm mt-2">
                   <span class="sidebar-label"> <img src="image/vvit.png" alt="VVIT Logo" class="img-fluid mb-2 rounded-circle" style="height: 50px; width: 50px;"></span>
                </div>
                <div class="col-sm">
            ...
            <ul class="nav nav-pills flex-column mb-auto px-1"  id="navList">
                ...
                <li class="mb-3"><a href="fees.jsp" class="btn btn-outline-primary w-100 active"><i class="bi bi-cash me-2"></i><span class="sidebar-label"> Fees</span></a></li>
        ...
        <div class="col-md-10">
            ...
            <div class="d-flex justify-content-between align-items-center mt-4 px-3">
                <h3 style="color: black" class="fw-bold">Student Fees</h3>
            </div>
            <!-- Table -->
