...
<head>
  ...
  <style>
    ...
    .dataTables_filter {
      display: none !important;// remove default search box in table
    }
    ...
    .dt-button {
      border-radius: 20px !important;//curve border
    }
...
<br>
            <div class="row mb-3">
              <div class="col-md-4  ms-auto text-end">
                <input type="text" id="customSearch" class="form-control" placeholder="Search student details...">
              </div>
            </div>
            ...
            <div class="table-responsive ">
              <table id="studentTable" class="table table-striped table-hover align-middle text-center">
                ...
                <tr>
                  ...
                  <td>
                    <a href="ReportP.jsp?id=<%= pr.getId() %>" class="btn btn-sm btn-outline-success">
                      <i class="bi bi-cash-coin"></i> Proceed
                    </a>
                  </td>
                  <td>
                    <a href="report_update.jsp?id=<%= pr.getId() %>" class="text-primary me-2" title="Edit">
                      <i class="bi bi-pencil-square fs-5"></i>
                    </a>
                    <a href="report_delete?id=<%= pr.getId() %>" class="text-danger" title="Delete">
    ...
    {
    extend: 'excelHtml5',
    text: '<i class="bi bi-file-earmark-excel-fill text-white"></i> Export Excel',
      className: 'btn btn-excel btn-sm me-2'
    },

    {
    extend: 'pdfHtml5',
    text: '<i class="bi bi-file-earmark-pdf-fill text-white"></i> Export PDF',
    className: 'btn btn-pdf btn-sm me-2',
    orientation: 'landscape',
    pageSize: 'A4'
    },
    {
    extend: 'print',
    text: '<i class="bi bi-printer-fill text-white"></i> Print',
