        ...
        <div class="col-md-10">
            ...
            <%
                try {
                    ...
                    List<Registration> al = p.checkid_list(id);
                    for (Registration pr : al) {
            %>
            <br>
            <h3 class="fw-bold">Update Fees</h3>

            <div class="main-box">
                <h4>Update Student Fees Information</h4>
                <form action="report_update" method="post">
                    <input type="hidden" name="id" value="<%=pr.getId()%>">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <h7> <label for="firstname">First Name:</label></h7>
                            <input type="text" name="firstname" id="firstname" value="<%= pr.getFirstname() %>" class="form-control" readonly>
                        </div>
                        <div class="col-md-4 mb-3">
                            <h7><label for="middlename">Middle Name:</label></h7>
                            <input type="text" name="middlename"   class="form-control"value="<%= (pr.getMiddlename() != null) ? pr.getMiddlename() : "" %>" readonly>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" name="email" id="email" class="form-control" value="<%=pr.getEmail()%>" placeholder="Enter Email" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                            <h7><label for="phone" class="form-label">Phone:</label></h7>
                            <input type="text" name="phone" id="phone" class="form-control" value="<%=pr.getPhone()%>" placeholder="Enter Phone" readonly>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="course" id="phone" class="form-control" value="<%=pr.getCourse()%>" placeholder="Enter Phone" readonly>
                        </div>

                        <div class="col-md-4">
                            <h7><label for="fees" class="form-label">course Fees</label></h7>
                            <input type="text" class="form-control" id="fees" name="fees" value="<%=pr.getFee()%>" placeholder="Auto-filled Fee" readonly required />
                        </div>

                        <div class="col-md-4">
                            <h7><label for="fees" class="form-label">Preview Fees</label></h7>
                            <input type="text" id="feesp" name="feesp" class="form-control"
                                   value="<%= pr.getPaid() %>" readonly>
                        </div>
                    </div>
                    ...
                    <script>
                        function calculateRemaining() {
                            ...
                            const prePaid = parseInt(document.getElementById("feesp").value) ;  // Already paid
                            const currentPaid = parseInt(document.getElementById("paid").value) ; // Just now paid

                            const totalPaid = prePaid + currentPaid;
                            const remaining = fees - totalPaid;

                            document.getElementById("remain").value = remaining;
                        }
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="paid" name="paid" class="form-control" placeholder="Paid now">
                        </div>

                        <div class="col-md-6">
                            <h7><label>Remaining</label></h7>
                            <input type="text" id="remain" name="remain" class="form-control" placeholder="Remaining Fees"  value="<%= pr.getRemainingfees() %>" readonly>
                        </div>
                    </div>
